...
export const PROGRAMS: Record<ProgramSlug, ProgramConfig> = {
  ...
  archery: {
    ...
    type: "seasonal",
    enrollmentStatus: "open",
    ageRangeLabel: "Open to youth, teens, and adults",
    ...
    overviewBullets: [
      "Four Sunday sessions: May 10, 17, 24, and 31",
      "Two slots: 10:00 AM–12:00 PM or 1:00 PM–3:00 PM",
      "All equipment and safety gear provided",
      "Mandatory 30-minute safety and intro lesson for first-timers",
    ],
    heroImage: {
    ...
    pricingBlurb: "$125 for the full four-week May series.",
    scheduleBlurb: "Sunday four-week series with morning and afternoon slot options.",
    nextSteps: [
      "Sign in and choose the participant you want to register.",
      "Watch the eye-dominance video and choose the result.",
      "Pick the time slot that works for your family.",
      "Complete the archery waiver and pay in the same cart checkout.",
    ],
  },
  outdoor: {
    slug: "outdoor",

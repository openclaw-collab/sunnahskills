...
VALUES
  ...
  ('oakville', 'Oakville', 'Oakville', '2200 Speers Road, Oakville', 'active', '{"sort_order":2}')
...
UPDATE program_sessions
SET name = 'Oakville Girls 5-10 - Monday', season = NULL, capacity = 16, status = 'active', visible = 1, day_of_week = 'Monday', start_time = '14:30', end_time = '15:30', start_date = '2026-07-01', end_date = '2026-07-26'
...
INSERT INTO program_sessions (program_id, location_id, name, season, day_of_week, start_time, end_time, age_group, gender_group, capacity, start_date, end_date, status, visible)
SELECT 'bjj', 'oakville', 'Oakville Girls 5-10 - Monday', NULL, 'Monday', '14:30', '15:30', 'girls-5-10', 'female', 16, '2026-07-01', '2026-07-26', 'active', 1
WHERE NOT EXISTS (
  SELECT 1 FROM program_sessions
  WHERE program_id = 'bjj' AND location_id = 'oakville' AND age_group = 'girls-5-10' AND gender_group = 'female' AND day_of_week = 'Monday' AND start_time = '14:30' AND end_time = '15:30'
);
UPDATE program_sessions SET start_date = '2026-07-01', end_date = '2026-07-26'
WHERE program_id = 'bjj' AND location_id = 'oakville' AND age_group = 'girls-5-10' AND gender_group = 'female' AND day_of_week = 'Monday' AND start_time = '14:30' AND end_time = '15:30';
INSERT INTO program_sessions (program_id, location_id, name, season, day_of_week, start_time, end_time, age_group, gender_group, capacity, start_date, end_date, status, visible)
SELECT 'bjj', 'oakville', 'Oakville Girls 5-10 - Wednesday', NULL, 'Wednesday', '14:30', '15:30', 'girls-5-10', 'female', 16, '2026-07-01', '2026-07-26', 'active', 1
WHERE NOT EXISTS (
  SELECT 1 FROM program_sessions
  WHERE program_id = 'bjj' AND location_id = 'oakville' AND age_group = 'girls-5-10' AND gender_group = 'female' AND day_of_week = 'Wednesday' AND start_time = '14:30' AND end_time = '15:30'
);

UPDATE program_sessions
SET name = 'Oakville Boys 7-13 - Monday', season = NULL, capacity = 16, status = 'active', visible = 1, day_of_week = 'Monday', start_time = '14:30', end_time = '15:30', start_date = '2026-07-01', end_date = '2026-07-26'
...
INSERT INTO program_sessions (program_id, location_id, name, season, day_of_week, start_time, end_time, age_group, gender_group, capacity, start_date, end_date, status, visible)
SELECT 'bjj', 'oakville', 'Oakville Boys 7-13 - Monday', NULL, 'Monday', '14:30', '15:30', 'boys-7-13', 'male', 16, '2026-07-01', '2026-07-26', 'active', 1
WHERE NOT EXISTS (
  SELECT 1 FROM program_sessions
  WHERE program_id = 'bjj' AND location_id = 'oakville' AND age_group = 'boys-7-13' AND gender_group = 'male' AND day_of_week = 'Monday' AND start_time = '14:30' AND end_time = '15:30'
);
UPDATE program_sessions SET start_date = '2026-07-01', end_date = '2026-07-26'
WHERE program_id = 'bjj' AND location_id = 'oakville' AND age_group = 'boys-7-13' AND gender_group = 'male' AND day_of_week = 'Monday' AND start_time = '14:30' AND end_time = '15:30';
INSERT INTO program_sessions (program_id, location_id, name, season, day_of_week, start_time, end_time, age_group, gender_group, capacity, start_date, end_date, status, visible)
SELECT 'bjj', 'oakville', 'Oakville Boys 7-13 - Wednesday', NULL, 'Wednesday', '14:30', '15:30', 'boys-7-13', 'male', 16, '2026-07-01', '2026-07-26', 'active', 1
WHERE NOT EXISTS (
  SELECT 1 FROM program_sessions
  WHERE program_id = 'bjj' AND location_id = 'oakville' AND age_group = 'boys-7-13' AND gender_group = 'male' AND day_of_week = 'Wednesday' AND start_time = '14:30' AND end_time = '15:30'
);

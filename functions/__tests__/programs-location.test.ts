...
describe("GET /api/programs location catalog", () => {
  it("returns locations and keeps BJJ sessions tagged by location", async () => {
    ...
    mockDb.setMockData("program_sessions", [
      ...
      { id: 2, program_id: "bjj", location_id: "oakville", age_group: "boys-7-13", day_of_week: "Monday", start_time: "14:30", end_time: "15:30", start_date: "2026-07-01", end_date: "2026-07-26", visible: 1 },
      { id: 3, program_id: "bjj", location_id: "oakville", age_group: "boys-7-13", day_of_week: "Wednesday", start_time: "14:30", end_time: "15:30", start_date: "2026-07-01", end_date: "2026-07-26", visible: 1 },
    ]);
    ...
    expect(oakvilleSessions.map((session: any) => session.start_date)).toEqual(["2026-07-01", "2026-07-01"]);
    expect(oakvilleSessions.map((session: any) => session.end_date)).toEqual(["2026-07-26", "2026-07-26"]);
  });
});

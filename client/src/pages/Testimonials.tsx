  ...
  const testimonials = [
    {
      ...
      initials: "SM",
      bgColor: "bg-primary",
      content: "Ahmed handles conflict better now. Last month he used breathing techniques when frustrated instead of shutting down.",
    },
    {
      ...
      content: "Fatima built her first fire last month. Now she shows her brother the knots she learns. She actually wants to go outside on weekends now.",
    },
    {
      name: "Layla Hassan",
      child: "Omar (14)",
      ...
      content: "Omar's teacher noticed he waits his turn now without fidgeting. He applies the same breathing from archery when tests get stressful.",
    },
    {
      name: "Amina Ali",
      child: "Zainab (10)",

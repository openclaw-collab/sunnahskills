...
describe("POST /api/register/cart", () => {
  ...
  it("charges $130 for the first archery registration in a family cart", async () => {
    ...
    expect(data.summary.totalCents).toBe(13000);
    expect(data.summary.dueTodayCents).toBe(13000);
        ...
        lines: [
          {
            ...
            programDetails: {
              sessionId: 21,
              priceId: null,
              programSpecific: { eyeDominance: "right" },
            },
          },
          {
            programSlug: "archery",
            ...
            programDetails: {
              sessionId: 22,
              priceId: null,
              programSpecific: { eyeDominance: "left" },
            },
          },
        ],
        waivers: {
